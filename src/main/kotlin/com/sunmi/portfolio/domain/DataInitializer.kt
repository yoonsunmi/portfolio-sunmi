package com.sunmi.portfolio.domain

import com.sunmi.portfolio.domain.constant.SkillType
import com.sunmi.portfolio.domain.entity.*
import com.sunmi.portfolio.domain.repository.*
...
@Component
@Profile(value = ["default"])  // 프로필이 default일 때만 실행
class DataInitializer(
    ...
    fun initializeData() {
        ...
        // 스프링 bean 등록되고 construct 도 실행 확인 완료
